...
// Data imports (assuming these paths are correct relative to Loading.jsx)
...
export default function Loading() {
  ...
  // State for hover effects (from your original code)
  ...
  // Effect to handle initial redirection based on authentication status
  useEffect(() => {
    if (!isLoading) {
      // If authenticated, do NOT redirect away from the loading/homepage.
      // The user can stay here and access features.
      // If not authenticated, do nothing here; let the component render its public content.
      // The handleFindJobClick will manage redirection for unauthenticated users.
    }
  }, [isAuthenticated, isLoading, navigate]); // Dependencies for the effect

  // Handler for the "Find Job" button click and other interactive elements
  const handleFindJobClick = () => {
    if (!isAuthenticated) {
      // If not authenticated, redirect to the registration page
      navigate('/register');
    } else {
      // If authenticated, proceed to the find job page
      navigate('/find-job');
    }
  };
            ...
            <div className="hero-content">
              ...
              <div className="bg-white rounded-2xl p-2 shadow-lg mb-8 search-form">
                <div className="flex flex-col sm:flex-row gap-4 items-center">
                  ...
                  <select className="bg-white border border-gray-200 rounded-xl px-8 py-4 outline-none text-base min-w-[120px] focus:border-blue-500 transition-colors">
                  ...
                  <button
                    onClick={handleFindJobClick} // Use the new handler
                    className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-xl font-semibold transition-all text-base find-job-btn"
                  >
                    Find Job
                  </button>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-15 categories-grid">
            {categories.map((category, index) => (
              <div
                ...
                onClick={handleFindJobClick} // Clicking a category also prompts registration if not logged in
              >
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 companies-grid">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 cities-grid">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:col-span-1">
              ...
              <div className="relative rounded-xl overflow-hidden h-48 city-card">
                <img
                  src="https://i.pinimg.com/736x/6a/99/ee/6a99ee843798375c5f7049316e8d31ed.jpg"
      ...
      <style jsx>{`
        ...
        .particle-1 {
          ...
          animation: particleFloat 2s infinite; /* Added animation directly */
        }
        ...
        .particle-2 {
          ...
          animation: particleFloat 2.5s infinite 0.5s; /* Added animation directly */
        }

        /* Removed redundant group:hover animations as they are now direct */
        /* .group:hover .particle-1 { animation: particleFloat 2s infinite; } */
        /* .group:hover .particle-2 { animation: particleFloat 2.5s infinite 0.5s; } */
